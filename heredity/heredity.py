...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        sum_prob_gene = sum(probabilities[person]["gene"].values())
        for i in probabilities[person]["gene"]:
            probabilities[person]["gene"][i] /= sum_prob_gene
            
        sum_trait_gene = sum(probabilities[person]["trait"].values())
        for i in probabilities[person]["trait"]:
            probabilities[person]["trait"][i] /= sum_trait_gene
